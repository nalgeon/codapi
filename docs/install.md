...
```sh
cd /opt/codapi
curl -L -O "https://github.com/nalgeon/codapi/releases/download/0.9.0/codapi_0.9.0_linux_amd64.tar.gz"
tar xvzf codapi_0.9.0_linux_amd64.tar.gz
chmod +x codapi
rm -f codapi_0.9.0_linux_amd64.tar.gz
```
